...
var $lastLi = $lastList.find('li.last');
...
var removePre = function removePre(url) {
...
$('.addButton').on('click', function () {
  var url = window.prompt('请问你要添加的网址是:'); // console.log(url)

  var firstLetter = removePre(url)[0].toUpperCase();
